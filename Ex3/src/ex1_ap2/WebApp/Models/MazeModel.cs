...
namespace WebApp.Models
{
    ...
    public class MazeModel : IMazeModel
    {
        ...
        /// The playing clients
        /// </summary>
        private Dictionary<string, string> playingClients;
        ...
        public MazeModel()
        {
            ...
            playingClients = new Dictionary<string, string>();
        ...
        public Game start(string name, int rows, int cols, string clientId)
        {
        ...
        /// </returns>
        public Game join(string name, string clientId)
        {
            if (!games.ContainsKey(name) || (games[name].ClientB != null))
                //game doesn't exist or is already assigned
                return null;
            games[name].ClientB = clientId;
        ...
        public Game play(string direct, string client)
        {
