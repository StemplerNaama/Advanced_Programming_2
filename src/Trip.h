...
public:
    ...
    Point* getEndPoint();
    /**
     * sets the startPoint of trip
     */
    void setStartPoint();
    /**
     * sets the endPoint of trip
     */
    void setEndPoint();
    /**
    ...
    /**
     * @return true if we already calculated the path, false if not
     */
    bool getPathInit();
    /**
     * @param flag the bool condition to set if we calculate the path
     */
